...
class KoromothViewerCdkPyStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # --- CDK Parameters ---
        existing_bucket_name_param = CfnParameter(
            self,
            "ExistingBucketName",
            type="String",
        ...
        image_tags_table = dynamodb.Table(
            self,
            "ImageTagsTable",
        ...
        thumbnailer_lambda = nodejs.NodejsFunction(
            self,
            "ThumbnailerLambda",
        ...
        images_bucket.add_event_notification(
            s3.EventType.OBJECT_CREATED, s3n.LambdaDestination(thumbnailer_lambda)
        )

        serve_image_lambda = nodejs.NodejsFunction(
            self,
            "ServeImageLambda",
        ...
        get_images_lambda = nodejs.NodejsFunction(
            self,
            "GetImagesLambda",
        ...
        get_tags_lambda = nodejs.NodejsFunction(
            self,
            "GetTagsLambda",
        ...
        if no_ui_str != "true":
            ...
            s3_deployment.BucketDeployment(
                self,
                "DeployUi",
                sources=[s3_deployment.Source.asset("ui/dist")],
