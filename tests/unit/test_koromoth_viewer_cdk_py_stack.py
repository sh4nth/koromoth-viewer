...
def test_api_gateway_integrations():
    ...
    get_images_lambda_id = stack.get_logical_id(get_images_lambda_construct.node.default_child)
    ...
    template.has_resource_properties("AWS::ApiGateway::Method", {
        ...
        "Integration": {
            "Uri": { "Fn::Join": [ "", [
                ...
                ":lambda:path/2015-03-31/functions/", { "Fn::GetAtt": [ get_images_lambda_id, "Arn" ] }, "/invocations"
            ]]}
        }
    })
    ...
    add_tags_lambda_id = stack.get_logical_id(add_tags_lambda_construct.node.default_child)
    ...
    template.has_resource_properties("AWS::ApiGateway::Method", {
        ...
        "Integration": {
            "Uri": { "Fn::Join": [ "", [
                "arn:", { "Ref": "AWS::Partition" }, ":apigateway:", { "Ref": "AWS::Region" },
                ":lambda:path/2015-03-31/functions/", { "Fn::GetAtt": [ add_tags_lambda_id, "Arn" ] }, "/invocations"
            ]]}
        }
    })
